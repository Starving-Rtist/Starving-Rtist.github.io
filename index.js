const BASE_URL = ('index.json') //SWITCHING between "https://my-json-server.typicode.com/Starving-Rtist/Starving-Rtist.github.io/dishes" and "http://localhost:3000/dishes" for web hosting purposes
